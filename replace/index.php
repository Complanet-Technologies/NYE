...
if(isset($_POST['search'])){
    ...
    $bus_location = $search_row['bus_location']; ?>
...
<div class="properties pb-20">
        <div class="properties__card">
            ...
            <div class="properties__footer d-flex justify-content-between align-items-center">
                ...
                <div class="heart">
                    <i class="fa fa-map-marker"><?php echo $bus_location?></i>
                </div>
            </div>
        </div>
    </div>
...
<div id="search_result" class="popular-directorya-area  border-bottom section-padding40 fix">
  ...
  <?php
                    ...
                    $bus_location = $nye_row['bus_location'];
                ...
                <div class="directory-active">
                    ...
                    while($blog_row = $blog_result->fetch_array()){
                        if(!empty($blog_row)){
                            ...
                            $blog_image = $blog_row['blog_image'];
                            $blog_title = $blog_row['blog_title'];
                            $blog_text = $blog_row['blog_text'];
                            $blog_author = $blog_row['blog_author'];
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <h3><a href="#"><?php echo $blog_title?></a></h3>
                                <p><?php echo $blog_text?></p>
                            </div>
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name">
                                    <i class="fa fa-user" style="color: black;"> </i>
                                    <h3><?php echo $blog_author?></h3>
                                </div>
